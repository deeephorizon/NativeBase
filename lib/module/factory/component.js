...
export default function Factory(Component, componentTheme) {
  const Forwarded = /*#__PURE__*/React.forwardRef(function FactoryForwardRef(props, ref) {
    const {
      children,
      _state,
      ...rest
    ...
    const calculatedProps = usePropsWithComponentTheme(componentTheme !== null && componentTheme !== void 0 ? componentTheme : {}, rest, _state);
