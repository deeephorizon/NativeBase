...
type PressableChildren = React.ReactNode | (({ isPressed, isHovered, isFocused, }: {
    isPressed: boolean;
    isHovered: boolean;
    isFocused: boolean;
}) => any);
export interface InterfacePressableProps<T = IPressableProps> extends Omit<PressableProps, 'children'>, StyledProps, PlatformProps<T> {
    /**
