...
import type { ColorSchemeType, CustomProps, ResponsiveValue, ThemeComponentSizeType } from '../../../components/types';
import type { IColors } from '../../../theme/base/colors';
import type { InterfaceBoxProps } from '../Box';
export interface InterfaceSwitchProps extends Omit<SwitchProps, 'tintColor' | 'children'>, InterfaceBoxProps<ISwitchProps> {
    /**
