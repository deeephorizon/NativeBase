...
export interface InterfaceIconProps extends Omit<SvgProps, 'opacity' | 'stroke' | 'height' | 'width' | 'transform' | 'color' | 'letterSpacing' | 'textDecoration' | 'fontFamily' | 'fontSize' | 'fontStyle' | 'fontWeight'>, StyledProps, PlatformProps<IIconProps> {
    /**
