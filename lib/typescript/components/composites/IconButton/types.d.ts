...
export interface InterfaceIconButtonProps extends Omit<InterfacePressableProps<InterfaceIconButtonProps>, 'children' | 'color' | '_light' | '_dark' | '_web' | '_android' | '_ios' | '_important' | 'fontFamily' | 'fontSize' | 'fontStyle' | 'fontWeight'>, Omit<IIconProps, 'delayLongPress' | 'disabled' | 'hitSlop' | 'onLongPress' | 'onPress' | 'onPressIn' | 'onPressOut' | 'style' | 'size' | '_light' | '_dark' | '_web' | '_android' | '_ios' | '_important' | 'fontFamily' | 'fontSize' | 'fontStyle' | 'fontWeight'>, PlatformProps<IIconButtonProps> {
    /**
