...
describe('Text component', () => {
  ...
  it('tests letterSpacing in em from token in text ', () => {
    ...
    try {
      ...
      expect((e === null || e === void 0 ? void 0 : (_e$message = e.message) === null || _e$message === void 0 ? void 0 : _e$message.includes('"letterSpacing": "0.1em"')) || (e === null || e === void 0 ? void 0 : (_e$message2 = e.message) === null || _e$message2 === void 0 ? void 0 : _e$message2.includes('document is not defined'))).toBe(true);
    } finally {
