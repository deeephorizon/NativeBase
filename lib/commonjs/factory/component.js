...
function Factory(Component, componentTheme) {
  const Forwarded = /*#__PURE__*/_react.default.forwardRef(function FactoryForwardRef(props, ref) {
    const {
      children,
      _state,
      ...rest
    ...
    const calculatedProps = (0, _usePropsWithComponentTheme.usePropsWithComponentTheme)(componentTheme !== null && componentTheme !== void 0 ? componentTheme : {}, rest, _state);
