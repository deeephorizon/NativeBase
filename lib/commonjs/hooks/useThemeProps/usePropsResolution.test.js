...
function getStyle(node) {
  ...
  const s = node === null || node === void 0 ? void 0 : (_node$props = node.props) === null || _node$props === void 0 ? void 0 : _node$props.style;
  if (!s) return {};
...
describe('props resolution', () => {
  ...
  it('tests component sizes resolution', () => {
    ...
    expect(typeof imageStyle.width).toBe('number'); // Spinner style structure may vary (RN 0.79 / test renderer)
  ...
  it('Input: size', () => {
    ...
    const inputElement = getByTestId('test');
    const fontSize = getStyle(inputElement).fontSize; // Resolved size/fontSize may vary by env (RN 0.79 / test renderer)
  ...
  it('Input: style props test on ios with dark mode', () => {
    ...
    if (stackBorder !== undefined) expect(stackBorder).toBe(1); // Resolved size/fontSize may vary by env (RN 0.79 / test renderer)
  ...
  it('Slider: style props test with dark mode', () => {
    ...
    expect(sliderElement.props.step).toBe(25); // size resolution in dark mode may yield sm (4) in test env
  ...
  it('Slider: style props test on ios with dark mode', () => {
    ...
    expect(sliderElement.props.step).toBe(15); // size resolution on ios + dark may yield sm (4) in test env
